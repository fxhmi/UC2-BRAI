...
prasarana_logo_path = 'assets/Deployment Code Test/Rapid_KL_Logo.png'
...
new_icon_path = 'assets/Deployment Code Test/icons8-driver-100.png'
new_icon = Image.open(new_icon_path)
new_icon_width = 400

icon_path = 'assets/Deployment Code Test/icons8-bus-100.png'
